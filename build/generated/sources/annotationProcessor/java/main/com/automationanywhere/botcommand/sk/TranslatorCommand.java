...
public final class TranslatorCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(TranslatorCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    Translator command = new Translator();
    ...
    if(parameters.get("fromto") == null || parameters.get("fromto").get() == null) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.notEmpty","fromto"));
    }
    ...
    if(parameters.get("fromto") != null && parameters.get("fromto").get() != null && !(parameters.get("fromto").get() instanceof String)) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","fromto", "String", parameters.get("fromto").get().getClass().getSimpleName()));
    }
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.nlp(parameters.get("textstr") != null ? (String)parameters.get("textstr").get() : (String)null ,parameters.get("fromto") != null ? (String)parameters.get("fromto").get() : (String)null ,parameters.get("url") != null ? (String)parameters.get("url").get() : (String)null ,parameters.get("apikey") != null ? (SecureString)parameters.get("apikey").get() : (SecureString)null ));
